...
from chop.passes.graph.transforms.pruning import (
    channel_pruning,
    kernel_pruning
)
...
def run_with_config(config_file):
    ...
    # Perform channel pruning
    channel_pruning(model, sparsity=0.2)
    # Perform kernel pruning
    kernel_pruning(model, layer_name="conv1", sparsity=0.2)
